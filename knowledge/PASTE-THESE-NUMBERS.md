# Paste these. Don't type them from memory.

Copy the block. Every figure below is the verified one, and the reason they matter is at the
bottom.

---

## Full block — for an email or a media-kit reply
...
## Paved bundles as submitted 21 Aug

```
Single newsletter edition: $750
Q4 package, 3 editions (Oct/Nov/Dec): $2,000
6 editions (2 per month): $3,500
1 LinkedIn post: $1,500
1 newsletter + 1 LinkedIn: $2,000
Q4 Full Stack, 3 newsletter + 3 LinkedIn: $5,500
```
...
Two emails have now gone out with different, higher numbers than the verified ones:
...
- **Paved requires post-send stats.** A campaign sold on 40% that reports ~25% produces a
